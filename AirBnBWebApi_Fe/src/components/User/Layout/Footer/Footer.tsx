...
const Footer: React.FC = () => {
  return (
    <div className="border-t mt-5 pt-5 bg-gray-100">
      <div className="container mb-5 grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 px-10 pb-10 mb-5">
      ...
      <AntFooter className="bg-gray-50 border-t fixed bottom-0 w-screen z-10 py-3 hidden md:block">
        <div className="container mx-auto px-8 flex justify-between items-center text-gray-500 max-lg:text-xs">
          ...
          <div className="text-gray-700">
            ...
            <span className="hover:underline cursor-pointer px-2 font-medium"><DollarOutlined /> VNĐ</span>
